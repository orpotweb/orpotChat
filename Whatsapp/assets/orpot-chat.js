(function ($) {
    $.fn.orpotChat = function (options) {
        ...
        //set the .orpot-chat default class
        this.addClass('orpot-chat');
        ...
        //#region Main Button
        $buttonImageContainer.addClass('orpot-chat-button-image');

        $button.addClass('orpot-chat-button')
        ...
        if (settings.showPopup) {
            ...
            $popup.addClass('orpot-chat-popup');
            $header.addClass('orpot-chat-head');
            $popupMessage.addClass('orpot-chat-message');
            $inputMessage.addClass('orpot-chat-input-message');
            $btnSend.addClass('orpot-chat-btn-send');
